...
sn.countplot(data=trainBuild,x="yearbuilt",ax=ax, color = 'red')
ax.set(xlabel='build_year', ylabel='count',title="Buildings/Year",label='big')
...
plt.xticks(rotation=90)
sn.barplot(data=features.head(30),x="features",y="importance",ax=ax,orient="v",color="red")
